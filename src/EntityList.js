...
const Entities = () => {
    ...
    //                 inputType: field.inputType || 'Static dropdown',
    //                 value: field.value || '0:Male,1:Female',
...
//     const handleExport = () => {
//         const processedTableFields = processStaticDropdownValues();
//         const json = JSON.stringify(processedTableFields);
//         const blob = new Blob([json], { type: 'application/json' });
//         saveAs(blob, 'tableFieldData.json');
//         handleWindowClose();
//         navigate(`/table/${currentTable}`);
...
//                 break;
//             case 'Dynamic dropdown':
//                 const foreignKeyTable = newTableFields[index].foreignKeyTable;
//                 newTableFields[index].value = `${primaryKeyOfForeignKeyTable}-columnName`;
//                 break;
//             case 'Radio group':
//                 newTableFields[index].value = '0-Male,1-Female';
