...
export default function HeaderTable({ tablename }) {
    ...
    const handleEdit = (rowData) => {
        ...
        navigate(`/headerEdit/${tablename}/${rowData.id}`);
    };
                        ...
                        <Card style={{ backgroundColor: "#f0f0f0" }}>
                            <CardContent>
                                <div style={{ backgroundColor: "#f0f0f0" }}>
                                    ...
                                    <Typography variant="h5" color="#8EB2C8" style={{marginLeft:"2%"}}>
                                        {tablename}
                                    </Typography>
